    ...
    $.fn.pwi = function (opts) {
        ...
        function getAlbums() {
            if (settings.albumstore.feed) {
                ...
                show(true, '');
                var $u = strings.picasaUrl + settings.username + '?kind=album&access=' + settings.albumTypes + '&alt=json&thumbsize=' + settings.albumThumbSize + (settings.albumCrop ? "c" : "u");
...
//                document.body.style.cursor = "default";
    ...
    $.fn.pwi.strings = {
        ...
        picasaUrl: "http://picasaweb.google.com/data/feed/api/usr/"
    };
})(jQuery);
